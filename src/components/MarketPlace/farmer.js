        ...
        return (
            <div>
                <div className="header">
                   <button className="mb-2 ml-2 mt-2 submit-query" onClick={handleShow}>POST A JOB </button>
                </div>
                {/* form */}
                    ...
                    <CardDeck>
                        <Card>
                            ...
                            <Card.Body className="text-center">
                                <Card.Title>Akintade Sharon</Card.Title>
                                <p class="text-warning">+2348023444488</p>
                                <Card.Text>
                        ...
                        <Card>
                            <Card.Img variant="top" src={profile} alt="farmer's picture" />
                            <Card.Body className="text-center">
                                <Card.Title>Christopher Akintade</Card.Title>
                                <p class="text-warning">+2348133470133</p>
                                <Card.Text >
